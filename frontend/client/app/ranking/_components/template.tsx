                    ...
                    <div className="flex items-center gap-8">
                      <div className="relative size-48 flex justify-center items-center">
                        <Image
                          ...
                          alt="next"
                          fill
                          className="rounded-8 aspect-square object-contain bg-white border border-gray-40"
                        />
                      </div>
                ...
                <React.Fragment key={item.id}>
                  ...
                  >
                    <div className="flex gap-8 h-fit items-center">
                      <div className="size-48 p-1 bg-white shrink-0 overflow-hidden rounded-8 flex justify-center items-center border border-gray-40">
